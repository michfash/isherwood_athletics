...
else
{
	...
	header("location:".__BASE_URL__."admin/colours/index.php?notifMsg=".base64_encode($feedback)."&notifType=".base64_encode("warning"));
}

#load object
$colourDetails = new Colours();

#load colour by colourID
$colour = $colourDetails->load($colourID);
...
if(isset($_REQUEST['btnEdit']))
{
	...
	#set object property
	$colourDetails->setProperty('colourDescription',$colourDesc);
	
	#update table
	$result = $colourDetails->update();
	
	if(isset($result) && !empty($result))
	{
		#update successful and redirect to index page
		$msg = "Colour edit was Successful!";
		$msg_type = "success";
	...
	else
	{
		...
		$msg = "Colour edit was NOT Successful!";
		$msg_type = "warning";
		header("location:".__BASE_URL__."admin/colours/index.php?notifMsg=".base64_encode($msg)."&notifType=".base64_encode($msg_type));
	}
                    ...
                    <table width="486" style="font-size:12px">
                        <tr>
                            ...
                            <td width="321">
                                ...
                                value="<?php echo $colourDetails->getProperty('colourDescription') ;?>" /><span style="color:#F00">*</span>
                            </td>
                        </tr>
                        <tr>
                        	<td>&nbsp;</td>
