...
#load
$item = $productDetails->loadItem($variationID);
...
if(isset($_REQUEST['btnEdit']))
{
	...
	#set object property
	$productDetails->setProperty('variationID',$variationID);
	...
	#update table
	$result = $productDetails->updateItem();
	
	if(isset($result) && !empty($result))
	{
		#update successful and redirect to index page
		$msg = "Item edit was Successful!";
		$msg_type = "success";
	...
	else
	{
		...
		$msg = "Item edit was NOT Successful!";
		$msg_type = "warning";
		header("location:".__BASE_URL__."admin/products/index.php?notifMsg=".base64_encode($msg)."&notifType=".base64_encode($msg_type));
	}
...
<a href="<?php echo __BASE_URL__ ;?>admin/products/edit.php?productID=<?php echo $product[0]['productID'] ; ?>">
               ...
               <div style="clear:both">&nbsp;</div>
                <div style="clear:both;float:right;font-size:18px;margin-top:-25px">
                    <a href="<?php echo __BASE_URL__ ;?>admin/products/new_item.php?productID=<?php echo $item[0]['productID'] ;?>">Add New</a>
                </div>
                    ...
                    <table width="486" style="font-size:12px">
                        <tr>
                            ...
                            <td width="321">
                                ...
                                <?php
									...
									{
								?>
                                	<option <?php echo ($value['sizeID'] == $item[0]['sizeID']) ? 'selected' :'' ;?> 
                                    value="<?php echo $value['sizeID'] ;?>"><?php echo $value['sizeDescription'] ;?></option>
                                 <?php
									}
								 ?>
                                </select>
                        ...
                        <tr>
                            ...
                            <td width="321">
                                ...
                                <option value="">Select Colour</option>
									...
									{
								?>
                                	<option <?php echo ($value['colourID'] == $item[0]['colourID']) ? 'selected' :'' ;?> 
                                    value="<?php echo $value['colourID'] ;?>"><?php echo $value['colourDescription'] ;?></option>
                                 <?php
									}
								 ?>
                                </select>
                        ...
                        <tr>
                            ...
                            <td width="321">
                                ...
                                value="<?php echo $item[0]['stock'] ;?>" size="6" /><span style="color:#F00">*</span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td width="321">
                                ...
                                value="<?php echo $item[0]['price'] ;?>" size="6" /><span style="color:#F00">*</span>
                            </td>
                        </tr>
                        <tr>
                        	<td>&nbsp;</td>
